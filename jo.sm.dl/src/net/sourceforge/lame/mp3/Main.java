...
public class Main
{
     ...
     */
    private int parse_args_from_string(final String argv,
            final StringBuilder inPath, final StringBuilder outPath)
    {
        /* Quick & very Dirty */
        ...
        return lame.getParser().parse_args(lame.getFlags(), args, inPath,
                outPath, null, null);
    }
