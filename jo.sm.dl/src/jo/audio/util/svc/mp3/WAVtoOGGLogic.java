...
public class WAVtoOGGLogic
{
    ...
    public static void convert(InputStream fin, OutputStream fos)
    {
        boolean eos = false;
        ...
        if ( !encoder.vorbis_encode_init_vbr( vi, 2, 44100, .3f ) ) {
            System.err.println( "Failed to Initialize vorbisenc" );
            return;
        }
        ...
        if ( !vd.vorbis_analysis_init( vi ) ) {
            System.err.println( "Failed to Initialize vorbis_dsp_state" );
            return;
        }
